			...
			if (!text || !text.length) {
				...
				try {
					...
					var request = new XMLHttpRequest()
						request.open("GET", "https://script.google.com/macros/s/AKfycbzfQhGlEqH9aQiYaHMYR1-c7BRnSDY2YACWk7GSzkQs2zPNLoc/exec?project=chalice&time=" + time + "&email=" + email + "&text=" + text, true)
